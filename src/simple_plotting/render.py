...
class EyeGazeRenderer:
    ...
    def render_eye(self, yaw_deg=40, pitch_deg=0):
        ...
        img = self.draw_cross_cam_mm(img, x_mm, y_mm)
        return img
...
if __name__ == "__main__":
    renderer = EyeGazeRenderer(radius=7.7, eye_color="hazel")
    renderer.set_pupil_diameter(2.0)  # ✅ change pupil diameter here
    img = renderer.render_eye(yaw_deg=0, pitch_deg=0)
    renderer.close()
