...
if __name__ == "__main__":
    renderer = EyeGazeRenderer(radius=7.7, eye_color="green")
    renderer.enable_orthographic()
    renderer.set_pupil_diameter(6.0)  # ✅ change pupil diameter here
    img = renderer.render_eye(yaw_deg=4, pitch_deg=2)
    renderer.close()
