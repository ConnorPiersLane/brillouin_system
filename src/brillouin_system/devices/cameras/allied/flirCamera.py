import brillouin_system.devices.BrillouinDevice
import time
import PySpin
import cv2
...
class FlirCamera(brillouin_system.devices.BrillouinDevice.Device):

    # This class always runs, so it takes app as an argument
    def __init__(self, stop_event, app):
        super(FlirCamera, self).__init__(stop_event)   #runMode=0 default
...
# to the GUI
class MakoFreerun(brillouin_system.devices.BrillouinDevice.DeviceProcess):
