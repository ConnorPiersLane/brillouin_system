import brillouinDAQ.Devices.BrillouinDevice
import time
import PySpin
import cv2
...
class FlirCamera(brillouinDAQ.Devices.BrillouinDevice.Device):
...
# to the GUI
class MakoFreerun(brillouinDAQ.Devices.BrillouinDevice.DeviceProcess):
