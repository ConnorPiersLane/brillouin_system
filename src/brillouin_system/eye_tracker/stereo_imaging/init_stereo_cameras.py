...
from brillouin_system.eye_tracker.stereo_imaging.stereo_cameras import StereoCameras   # your renamed class
from brillouin_system.eye_tracker.stereo_imaging.calibration_dataclasses import Intrinsics, StereoExtrinsics, StereoCalibration
