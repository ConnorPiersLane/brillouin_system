...
FITTING_MODELS_SAMPLE = ["lorentzian", "lorentzian_quad_bg", "lorentzian_window", "lorentzian_psf", "lorentzian_psf_window", "voigt", "voigt_window", "asym_lorentzian", "asym_lorentzian_window", "dho", "dho_window", "dho_psf", "dho_psf_window"]
